...
GT_PATH = os.path.join('../data/eu', 'input', 'ground-truth')
DR_PATH = os.path.join('../data/eu', 'input', 'detection-results')
# if there are no images then no animation can be shown
IMG_PATH = os.path.join('../data/eu', 'input', 'images-optional')
...
"""
TEMP_FILES_PATH = "../data/eu/temp_files"
if not os.path.exists(TEMP_FILES_PATH): # if it doesn't exist already
    os.makedirs(TEMP_FILES_PATH)
output_files_path = "../data/eu/output"
...
with open(output_files_path + "/output.txt", 'w') as output_file:
    ...
    for class_index, class_name in enumerate(gt_classes):
        ...
        if draw_plot:
            ...
            #plt.show()
            # save the plot
            fig.savefig(output_files_path + "/classes/" + class_name + ".jpg")
...
#     output_path = output_files_path + "/ground-truth-info.jpg"
#     to_show = False
...
#     # end Plot title
#     x_label = "Number of objects per class"
#     output_path = output_files_path + "/detection-results-info.jpg"
#     to_show = False
#     plot_color = 'forestgreen'
...
#     output_path = output_files_path + "/lamr.jpg"
#     to_show = False
...
if draw_plot:
    ...
    output_path = output_files_path + "/mAP.jpg"
    to_show = True
    plot_color = 'royalblue'
    draw_plot_func(
        ap_dictionary,
