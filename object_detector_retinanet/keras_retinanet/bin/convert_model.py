...
def parse_args(args):
    ...
    parser.add_argument('model_in', help='The model to convert.',default='./snapshot/Thu_Apr_30_17_03_35_2020/resnet50_csv_01.h5')
    parser.add_argument('model_out', help='Path to save the converted model to.',default='./detect_model')
